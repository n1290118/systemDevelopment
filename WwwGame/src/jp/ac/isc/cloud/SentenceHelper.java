...
public class SentenceHelper {
	...
	private static final String[] whenList = {"さっき","昨日",
	"あれはもう3年も昔","紀元前","ジュラ紀"};
	private static final String[] whereList = {"自宅で","近くの居酒屋で",
	"世界のまんなかで","追い込み中のプロジェクトで","木星で"};
	private static final String[] whoList = {"わたしが","あなたが",
	"オヤジが","あこがれのアイドルが","神が"};
